...
export default function Page() {
  return (
    <div className="w-full h-screen center ">
      <InfiniteMarquee speed={80} draggable>
          <div className=" gap-x-5 ml-5 select-none inline-flex pointer-events-none">
            <div className=" w-[30vh] md:w-[20vw] aspect-3/4 select-none">
