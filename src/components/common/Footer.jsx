  ...
  return (
    <>
      ...
      <div className="w-full padding py-5! space-y-20 ">
        <p className='text-5xl font-medium  leading-none'> <br /> Made for<span className=' ml-1 bg-pattern'>  Designers.</span>  <br />Built for Storytellers.</p>
        ...
        <div className="w-full text-center">
          <p className='text-[7.92vw] whitespace-nowrap leading-none uppercase font-semibold'>25 Rupiya Production</p>
        </div>
